  ...
  return (
    ...
    >
      <button
        ...
        className="h-11 w-4 min-w-0 shrink-0 cursor-grab rounded-md text-muted-foreground opacity-40 transition-opacity motion-reduce:transition-none group-hover:opacity-100 focus-visible:opacity-100 [@media(pointer:coarse)]:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 active:cursor-grabbing disabled:cursor-default"
